...
$data = [
    'ten_trang' => 'Chỉnh sửa phim | Movie Booking'
];
    ...
    <main>
        <div class="list">
            ...
            <span class="thong_bao">
                <?php
                echo !empty($_SESSION['update_thanh_cong_phim']) ? $_SESSION['update_thanh_cong_phim'] : '';
                unset($_SESSION['update_thanh_cong_phim']);
                ?>
            </span>
            <hr>
            <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="?module=admin&action=xulyeditphim" method="post" class="edit">
                                    <input type="hidden" name="id_phim" value="<?php echo $rows['id_phim']; ?>">
            ...
            <div class="phan_trang">
                ...
                if ($vt_page > 1 && $total_page > 1) {
                    echo '<a href="?module=admin&action=editphim&page=' . ($vt_page - 1) . '"> < </a>';
                }
                //Lập khoảng giữa 
                for ($i = 1; $i <= $total_page; $i++) {
                    if ($i == $vt_page) {
                        ...
                        echo '<a href="?module=admin&action=editphim&page=' . $i . '">' . $i . '</a>';
                    }
                }
