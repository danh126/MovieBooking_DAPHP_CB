...
$data = [
    'ten_trang' => 'Chỉnh sửa quà tặng | Movie Booking'
];
    ...
    <main>
        <div class="list">
            ...
            <span class="thong_bao">
                <?php
                echo !empty($_SESSION['thay_doi_qua_tang']) ?  $_SESSION['thay_doi_qua_tang'] : '';
                unset($_SESSION['thay_doi_qua_tang']);
                ?>
            </span>
            <hr>
            <table>
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <form action="?module=admin&action=xulyeditquatang" method="post" class="edit">
            ...
            <div class="phan_trang">
                ...
                if ($vt_page > 1 && $total_page > 1) {
                    echo '<a href="?module=admin&action=editquatang&page=' . ($vt_page - 1) . '"> < </a>';
                }
                //Lập khoảng giữa 
                for ($i = 1; $i <= $total_page; $i++) {
                    if ($i == $vt_page) {
                        ...
                        echo '<a href="?module=admin&action=editquatang&page=' . $i . '">' . $i . '</a>';
                    }
                }
