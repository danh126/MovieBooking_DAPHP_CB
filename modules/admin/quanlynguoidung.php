...
$data = [
    'ten_trang' => 'Quản lý người dùng | Movie Booking'
];
...
?>
    <main>
        <div class="list">
            <div class="tieu_de">
                <p>Danh người dùng</p>
                <span>Số lượng người dùng: <?php echo $smt ?></span>
            </div>
            <hr>
            <table>
                <tr>
                ...
                ?>
                        <tr>
                            ...
                            <td><?php echo $rows['so_dien_thoai_user']; ?></td>
                            <td><?php echo $rows['dia_chi_user']; ?></td>
                        </tr>
                <?php
                    } //KT while
                } //KT if
            ...
            <!-- <div class="tac_vu">
                <a href="?module=admin&action=themnguoidung">Thêm</a>
                <a href="?module=admin&action=editnguoidung">Sửa</a>
                <a href="?module=admin&action=deletenguoidung">Xóa</a>
            </div>-->
            <br><br>
